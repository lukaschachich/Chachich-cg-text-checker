...
def prepare_features_for_prediction(text, category="unknown"):
    ...
    # Use an absolute path to feature_names.json
    model_dir = Path(__file__).resolve().parents[1] / "model"
...
def main():
    ...
    st.markdown("A tool to determine whether a sentance was written by a human or generated by AI.")
